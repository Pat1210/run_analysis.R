...
[88] "Subject"                             
> names(extractedAcc)
Error: object 'extractedAcc' not found
...
> source("C:\\Users\\meade\\OneDrive\\Desktop\\run_analysis.R")
Error in file(filename, "r", encoding = encoding) : 
  cannot open the connection
In addition: Warning message:
In file(filename, "r", encoding = encoding) :
  cannot open file 'C:\Users\meade\OneDrive\Desktop\run_analysis.R': No such file or directory
> source("C:\\Users\\meade\\OneDrive\\Desktop\\run_analysis.R\\run_analysis.R")
Error in file(filename, "r", encoding = encoding) : 
  cannot open the connection
In addition: Warning message:
In file(filename, "r", encoding = encoding) :
  cannot open file 'C:\Users\meade\OneDrive\Desktop\run_analysis.R\run_analysis.R': No such file or directory
> 
